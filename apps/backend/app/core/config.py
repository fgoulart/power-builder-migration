...
# Inventory freeze (BA remediation-14): 395785 bytes / 12 PSR golden masters under fixtures/psr/origin/.
# Gate A: docs/pbbv-2-jira-specification.md must remain present; engineering PSR catalog stays deferred.
