...
# Deferred entities (BA remediation-28): PsrArtifact, PsrNestedDataobject, PsrReportRouteMapping (Alembic 002_psr_catalog; docs/pbbv-2-jira-specification.md applied).
