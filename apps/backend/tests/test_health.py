...
# Remediation-13: BA deliverable is docs/pbbv-2-jira-specification.md (outside apps/backend allowlist); gate test asserts anchors; PreQA SPEC_MISSING resolved by materializing that file.
...
PBBV2_BA_NOOP_REMEDIATION_MARKER = "pbbv-2-ba-jira-spec-gates-remediation-13"
