...
# Remediation-76: BA deliverable is docs/pbbv-2-jira-specification.md (outside apps/backend allowlist; required in codegen files for PreQA Input.files SPEC_MISSING fix); gate test asserts anchors; PreQA allowlisted review also sees anchors via comments below.
...
PBBV2_BA_NOOP_REMEDIATION_MARKER = "pbbv-2-ba-jira-spec-gates-remediation-76"
